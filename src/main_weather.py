...
if __name__ == "__main__":
    ...
    weather_forecast_next_24_hour = weather_provider.fetch_24_hour_forecast()

    if weather_forecast_next_24_hour is not None:
        for w_3_hour in weather_forecast_next_24_hour:
            properties = {
                ...
                "temp": {"number": float(w_3_hour.get("temp"))},
                "weather": {
                    "rich_text": [{"text": {"content": w_3_hour.get("weather")}}]
                },
                "description": {
                    "rich_text": [{"text": {"content": w_3_hour.get("description")}}]
                },
